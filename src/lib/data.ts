...
export const experiencePT = [
  ...
  },
  {
    ...
    position: 'Consultor de Tecnologia',
    period: '2024 - 2025',
    description: 'Consultoria técnica para desenvolvimento de MVP voltado à Prefeitura Municipal de São José dos Pinhais. Conduzi o Product Discovery completo com levantamento de requisitos, definição de escopo técnico e mapeamento de user journeys. Partipei ativamente do Sprint Review apresentando o MVP para stakeholders do setor público. Implementação inicial utilizando arquitetura serverless com focus em escalabilidade e compliance governamental.',
